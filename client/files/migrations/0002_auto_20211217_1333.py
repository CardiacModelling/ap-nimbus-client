...
#    m = PREDEF_MODELS[0]
#    CellmlModel.objects.create(author=user, visibility=Visibility.MODERATED,**m)
#    CellmlModel.objects.create(author=user, visibility=Visibility.MODERATED, name=r"O'Hara-Rudy", version='CiPA-v1.0', year=2017, description='human ventricular cell model (endocardial)', ap_predict_model_call= '8')
    for predef_model in PREDEF_MODELS:
        CellmlModel.objects.create(author=user, visibility=Visibility.MODERATED, **predef_model)
