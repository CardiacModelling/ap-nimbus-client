...
PREDEF_ION_CURRENTS = [
    ...
    {'name': 'INa',
     'metadata_tag': 'membrane_fast_sodium_current_conductance',
     'default_hill_coefficient': 1,
     'default_saturation_level': 0,
     'default_spread_of_uncertainty': 0.2},

    {'name': 'ICaL',
     'metadata_tag': 'membrane_L_type_calcium_current_conductance',
     'default_hill_coefficient': 1,
     'default_saturation_level': 0,
     'default_spread_of_uncertainty': 0.15},

    {'name': 'IKs',
     'metadata_tag': 'membrane_slow_delayed_rectifier_potassium_current_conductance',
     'default_hill_coefficient': 1,
     'default_saturation_level': 0,
     'default_spread_of_uncertainty': 0.17},

    {'name': 'IK1',
     'metadata_tag': 'membrane_inward_rectifier_potassium_current_conductance',
     'default_hill_coefficient': 1,
     'default_saturation_level': 0,
     'default_spread_of_uncertainty': 0.18},

    {'name': 'Ito',
     'metadata_tag': 'membrane_fast_transient_outward_current_conductance',
     'default_hill_coefficient': 1,
     'default_saturation_level': 0,
     'default_spread_of_uncertainty': 0.15},

    {'name': 'INaL',
     'metadata_tag': 'membrane_persistent_sodium_current_conductance',
     'default_hill_coefficient': 1,
     'default_saturation_level': 0,
     'default_spread_of_uncertainty': 0.2},
]
