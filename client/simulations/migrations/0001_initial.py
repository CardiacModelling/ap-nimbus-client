# Generated by Django 3.2.10 on 2022-01-27 15:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('QUEUED', 'Queued'), ('RUNNING', 'Running'), ('SUCCESS', 'Success'), ('FAILED', 'Status Failed')], default='QUEUED', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hill_coefficient', models.FloatField(default=1, help_text='Between 0.1 and 5.', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
