# Generated by Django 3.2.11 on 2022-02-09 17:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('NOT_STARTED', 'Not Started'), ('CALLING', 'Calling'), ('RUNNING', 'Running'), ('SUCCESS', 'Success'), ('FAILED', 'Failed')], default='NOT_STARTED', max_length=255)),
                ...
                ('pacing_frequency', models.FloatField(default=0.05, help_text='(in Hz) Frequency of pacing (between 0.05 and 5).', validators=[django.core.validators.MinValueValidator(0.05), django.core.validators.MaxValueValidator(5)])),
                ...
                ('ap_predict_q_net', models.CharField(blank=True, max_length=255)),
                ('ap_predict_voltage_traces', models.CharField(blank=True, max_length=255)),
                ('ap_predict_voltage_results', models.CharField(blank=True, max_length=255)),
